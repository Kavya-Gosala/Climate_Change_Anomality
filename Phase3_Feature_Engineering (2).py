...
df = pd.read_csv(r'C:\Users\uzwal\OneDrive\Desktop\DS\Climate changes\global_warming_clean.csv')
...
mapping_df.to_csv('country_encoding_map.csv', index=False)
...
df_model.to_csv(r'C:\Users\uzwal\OneDrive\Desktop\DS\Climate changes\global_warming_features.csv', index=False)
