...
df = pd.read_csv(r'data\global_warming_dataset.csv')
...
df.to_csv(r'data\global_warming_clean.csv', index=False)
...
plt.tight_layout()
plt.savefig(r'outputs\fig1_temperature_anomaly_trend.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'outputs\fig2_co2_trend.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'outputs\fig3_temperature_distribution.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'outputs\fig4_correlation_heatmap.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'outputs\fig5_top_countries_anomaly.png', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'outputs\fig6_anomaly_by_decade.png', bbox_inches='tight')
plt.show()
...
if 'sea_level_rise' in df.columns:
    ...
    plt.tight_layout()
    plt.savefig(r'outputs\fig7_sealevel_vs_temp.png', bbox_inches='tight')
    plt.show()
